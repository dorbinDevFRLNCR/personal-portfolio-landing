  ...
  return (
    <>
      ...
      <p>
        ...
        <br />
        {process.env.NEXT_PUBLIC_CITY} <br />
      </p>
      <p>
        {' '}
      ...
      <p>
        ...
        Telefon: {process.env.NEXT_PUBLIC_PHONE}
        <br />
        E-Mail:{' '}
      ...
      <p>
        Erstellt mit dem{' '}
        <a href="https://impressum-generator.de" target="_blank" rel="noopener noreferrer">
          Impressum-Generator
        </a>{' '}
        ...
        . Rechtstext von der{' '}
        <a href="https://www.kanzlei-hasselbach.de/" target="_blank" rel="noopener noreferrer">
          Kanzlei Hasselbach
        </a>
        .
      </p>
