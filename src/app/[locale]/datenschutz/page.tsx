...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | Kirill Pavlov',
  robots: {
    index: false,
    follow: false,
    nocache: true,
    ...
    <>
      <div className="privacy-policy">
        ...
        <p>
          ...
          zu welchen Zwecken und in welchem Umfang verarbeiten. Die Datenschutzerklärung gilt für
        ...
        <ul>
          <li>
            <strong>Berechtigte Interessen (Art. 6 Abs. 1 lit. f DSGVO)</strong> – Verarbeitung zur
            Wahrung berechtigter Interessen des Verantwortlichen, sofern nicht die Interessen oder
        ...
        <p>
          ...
          gehört insbesondere die Verarbeitung der IP-Adresse, die notwendig ist, um Inhalte an den
          Browser des Nutzers zu übertragen.
        </p>
